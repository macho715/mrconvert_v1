프로젝트 전체를 __온톨로지 관점__에서 정리하면, ‘HVDC 물류 생명주기’를 하나의 __지식그래프\(Ontology\)__ 로 모델링할 수 있습니다\.  
핵심은 __“물류행위\(Activity\)”가 아닌 “관계\(Relation\)”__ 중심으로 보는 것입니다 — 사람, 문서, 물품, 절차, 시스템 간의 연결망\.
