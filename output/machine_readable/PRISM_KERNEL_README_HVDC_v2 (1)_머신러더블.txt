[SECTION 1] PRISM.KERNEL.v1 — README (Cycle Template Standard)
...
[SECTION 5] 📝 Example (Invoice Audit)
...
[SECTION 6] 📦 HVDC Samsung C&T Workflows — Applied Examples

[SECTION 7] 1) Invoice Audit (OFCO · DSV · AD Ports · Others)
**Input**
```
Task: Invoice audit cycle
...
[SECTION 8] 2) CIPL·BL Pre-Arrival Guard (UAE Customs)
**Task**
...
[SECTION 9] 3) Warehouse Ops (DSV Indoor, DSV Outdoor, M44, Al Markaz, Hauler)
**Input**
```
...
[SECTION 10] 4) Stowage Simulation (LCT JPTW-71, DAS/AGI)
**Input**
```
